    ...
    public partial class Sample1Com : System.Web.UI.Page {
        protected void Page_Load(object sender, EventArgs e) {
            if(IsPostBack == false)
            {
                ...
                if(Request.Form.Get("rb_Gender")== "網頁廣告") { lb_Msg.Text = lb_Msg.Text + "網頁廣告" + "<br />"; }
                if (Request.Form.Get("rb_Gender") == "電視") { lb_Msg.Text = lb_Msg.Text + "電視" + "<br />"; }
                if (Request.Form.Get("rb_Gender") == "其他") { lb_Msg.Text = lb_Msg.Text + "其他" + "<br />"; }
